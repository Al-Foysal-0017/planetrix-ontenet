...
//         borderTop: 'calc(0.05vh + 0.5px) solid rgba(255, 255, 255, .3)' 
//       }} 
//       className='w-full px-[5vh] py-[4vh]'
//     >
...
//           <div className="relative w-[clamp(150px,18vh,350px)] h-[clamp(30px,4vh,70px)]">
//             <Image 
//               src="/logo.svg"  
//               alt="Planetrix Logo"
//               fill
...
//           <p className="hidden md:flex mt-[1vh] text-[clamp(0.8rem,1.1vh,1.2rem)] leading-[1.6] tracking-[0.05vh]">
...
//         <div className="flex flex-col gap-[0.5vh] text-[clamp(0.7rem,1.1vh,1.2rem)] text-gray-300 tracking-[0.2em] cursor-pointer pointer-events-auto">
